        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header with-border">
              <a href="#addnew" data-toggle="modal" class="btn btn-primary btn-sm btn-flat"><i class="fa fa-plus"></i> Tambah Jadwal</a>
            </div>
            <div class="box-body">
...
function getRow(id){
  $.ajax({
    ...
    success: function(response){
      $('.id').val(response.id);
      $('#edit_description1').val(response.description1);
      $('#edit_description2').val(response.description2);
      $('#edit_description3').val(response.description3);
      $('#edit_description4').val(response.description4);
